...
def check_original_route():
	...
	print("original folder: " + original_route)
	print("os folder: " + initial_folder)
...
def change_files(path_folder):
	...
	for f in os.listdir(path_folder):
		...
		#is a file
			...
			#only change java, kotlin, xml and gradle files
			if(str(f).endswith(".java") or str(f).endswith(".xml") or str(f).endswith(".gradle") or str(f).endswith(".kt") or str(f).endswith(".json")):
